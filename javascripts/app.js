...
(function($) {
  ...
  $(document).ready(function() {
    ...
    function submitForm(e) {
      ...
      const company_name = form.querySelector('input[name=company_name]').value;
      const email = form.querySelector('input[name=email]').value;
      const phone = form.querySelector('input[name=phone]').value;
      const format = form.querySelector('select[name=format]').value;
      const looking_for = form.querySelector('select[name=looking_for]').value;

      $.ajax({
        url: "https://formspree.io/gbatesy@gmail.com",
        method: "POST",
        data: {
          name,
          title,
